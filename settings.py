...
# See https://docs.djangoproject.com/en/3.0/ref/settings/#file-upload-permissions
...
# https://docs.djangoproject.com/en/3.0/topics/http/middleware/#upgrading-middleware
MIDDLEWARE = [
...
# See https://docs.djangoproject.com/en/3.0/ref/templates/upgrading/#the-templates-settings
TEMPLATES = [
    {
